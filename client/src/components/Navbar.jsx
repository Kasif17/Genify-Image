      ...
      <div>
        {
          ...
          <div className='flex items-center gap-2 sm:gap-3'>
            ...
            <p className='text-gray-600 max-sm:hidden pl-4'>Hi, Kasif</p>
          ...
          <div className='flex items-center gap-4 sm:gap-6'>
            ...
            <button onClick={()=>setShowLogin(true)} className='bg-zinc-800 text-white px-7 text-sm py-2 sm:px-10 rounded-full'>Login</button>
          </div>
        }
